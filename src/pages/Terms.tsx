...
const Terms = () => {
  return (
    <section className="w-full bg-slate-200 flex flex-col text-blue-850">
      <h1 className="w-full text-center font-extrabold text-blue-950 text-xl md:text-3xl mt-4">Terms And Conditions</h1>
      <section className=" flex flex-col items-center justify-around gap-16  pt-4 pb-4 md:text-lg text-blue-950 mb-6">
        <p className="w-[85%] md:w-[60%] text-start text-wrap">
